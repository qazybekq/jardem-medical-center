...
def show_import_data():
    ...
    import_type = st.radio(
        ...
        options=["Пациенты", "Врачи", "Услуги", "Приемы"],
        key="import_type"
    )
...
def show_templates():
    ...
    - `1_clients_template.xlsx` - Пациенты
    ...
    with st.expander("👥 Пациенты (Clients)"):
        st.code("""
Поля:
...
def show_instructions():
    ...
    - Импортируйте данные в порядке: Врачи → Услуги → Пациенты → Приемы
    """)
